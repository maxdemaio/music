...
export default defineConfig({
  ...
  shortcuts: {
    mlinkTextHover:
      "transition-color transition-background-color duration-150 hover:text-sky-950 dark:hover:text-sky-100 hover:bg-sky-50 dark:hover:bg-sky-950",
    soundLinkHover:
      "transition-color transition-background-color duration-150 hover:text-orange-950 dark:hover:text-orange-100 hover:bg-orange-50 dark:hover:bg-orange-950",
    mySponsorLinkHover:
      "transition-color transition-background-color duration-150 hover:text-pink-600 dark:hover:text-pink-50 hover:bg-pink-50 dark:hover:bg-pink-950",
    mlink:
