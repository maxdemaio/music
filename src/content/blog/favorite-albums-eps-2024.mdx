...
duration: 5
---
import SpotifyEmbed client:load from '../../components/SpotifyEmbed client:load.astro';
...
**TLDR**: Two Star & The Dream Police (Mk.gee), Requiem (Keshi), Dunya (Mustafa), Amy (Yana), Radical Optimism (Dua Lipa), Unfold (Kanako Yamamoto), TFL Blues (Zino Vinci), Charm (Clairo), Heavy Kinda Feeling (Henry Patterson), DOA (ericdoa)

## 1. Two Star & The Dream Police - Mk.gee

<SpotifyEmbed client:load albumId="6DlLdXBGCsSDPOV8R2pCl7" />
...
<SpotifyEmbed client:load client:load albumId="5DfKDonIvNlxlzA4ORIOFm" />
...
<SpotifyEmbed client:load client:load albumId="16sGrLUTzqz0Z43j9qMn8S" />
...
<SpotifyEmbed client:load client:load albumId="16ZKxf5jDH2L7UIQ19uNIz" />
...
<SpotifyEmbed client:load albumId="1Mo92916G2mmG7ajpmSVrc" />
...
<SpotifyEmbed client:load albumId="2fWAJ4ENbB3iRKsfOMKmn2" />
...
<SpotifyEmbed client:load albumId="7rF4TnnZS0QimTQRJHfFLg" />
...
<SpotifyEmbed client:load albumId="1KNUCVXgIxKUGiuEB8eG0i" />
...
<SpotifyEmbed client:load albumId="09aNITIqqQVM6WDtLq1UPA" />
...
<SpotifyEmbed client:load albumId="75ScphmWaaBgNOTUh4fatP" />
